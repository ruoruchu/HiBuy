							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="size_name" placeholder="" class="input-sm" />
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" type="button" onclick="AddSize();">
...
<![endif]-->
	...
	<script>
		...
		function AddSize() {
			...
			var url = '?c=Size&m=addSize';
			var data = 'size_name='+size_name+'&remark='+remark;
