							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input id="x" name="category_name" type="text" class="input-small" />
										</div>
									</div>
														...
														<div class="row">
															<ul class="ace-thumbnails" id="list_image_src" style="list-style: none">
																<li style="list-style: none;border: none"><a id="pre_img_a" href="" title="Photo Title" data-rel="colorbox" ><img id="pre_img_img" src=""></a><div class="tools">
																	...
																	</div><input type="text" value="" name="category_img" hidden></li>
...
<![endif]-->
	...
	<script>
		...
		function Submit() {
			...
			ajaxUpFile('?c=ProductCategory&m=addProductCategory', formdata, function (respText) {
