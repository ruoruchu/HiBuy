        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="?c=Shape&m=showAddShape" method="get">
                            <input type="hidden" name="c" value="Shape">
                            <input type="hidden" name="m" value="showAddShape">
                            形状名称：<input type="text" name=""><br>
