					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="/kingphp/hibuy/backend/?c=Color&m=showAddColor" method="get">
									<input type="text" name="c" value="Color" hidden>
									<input type="text" name="m" value="showAddColor" hidden>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"> 颜色值 </label>
										<div class="col-sm-9">
											<input id="colorpicker1" name="color_value" type="text" class="input-small" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="color_name" placeholder="白色" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="remark"  placeholder="备注" class="col-xs-10 col-sm-5" />
										</div>
									</div>
