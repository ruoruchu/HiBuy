					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<input name="color_id" type="text" value="<?php echo $colorInfo['color_id']; ?>" hidden>													<input id="colorpicker1" name="color_value" type="text" class="input-small" value="<?php echo $colorInfo['color_value']; ?>"/>
