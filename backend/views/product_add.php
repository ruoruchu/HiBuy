                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input id="x" name="product_no" type="text" class="input-small" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input id="x" name="product_name" type="text" class="input-small" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input id="x" name="product_subname" type="text" class="input-small" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input id="x" name="origin_price" type="text" class="input-small" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input id="x" name="discount_price" type="text" class="input-small" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input id="x" name="freight_limit" type="text" class="input-small" />
                                </div>
                            </div>
                                            ...
                                            <div class="widget-main">
                                                <div class="row">
                                                    <ul class="ace-thumbnails" id="list_image_src" style="list-style: none">
                                                        <li style="list-style: none;border: none"><a id="pre_img_a" href="" title="Photo Title" data-rel="colorbox" ><img id="pre_img_img" src=""></a><div class="tools">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input id="x" name="remark" type="text" class="input-small" />
                                </div>
                            </div>
