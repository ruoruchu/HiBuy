<?php
    ...
    $productStyleInfo = $GLOBALS['productStyleInfos'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover center">
                                ...
                                <tbody>
                                <?php foreach ($productStyleInfo as $info):?>
                                    <tr>
                                        <td><a href="?c=ProductStyle&m=updateProductStyle&productStyle_id=<?php echo $info['productStyle_id']; ?>"><?php echo $info['productStyle_id']; ?></a></td>
                                        ...
                                        <td>
                                            <a class="red" href="?c=ProductStyle&m=deleteProductStyle&productStyle_id=<?php echo $info['productStyle_id']; ?>">
