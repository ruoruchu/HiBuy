...
$productCategoryInfo = $GLOBALS['productCategoryInfo'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <input name="category_id" type="text" value="<?php echo $productCategoryInfo['category_id']; ?>" hidden>
                                    <input id="x" name="category_name" type="text" class="input-small"  value="<?php echo $productCategoryInfo['category_name']; ?>"/>
                                </div>
                            </div>
                                            ...
                                            <div class="widget-main">
                                                <div class="row">
                                                    <ul class="ace-thumbnails" id="list_image_src" style="list-style: none">
                                                        <li style="list-style: none;border: none"><a id="pre_img_a" href="" title="Photo Title" data-rel="colorbox"><img id="pre_img_img" src="<?php echo $productCategoryInfo['category_img']; ?>" ></a><div class="tools">
                                                                <a href="javascript:void(0);" onclick="DeleteImage(this);">
                                                                    <i class="icon-remove red"></i>
                                                                </a>
                                                            </div><input type="text" name="category_img" hidden></li>
...
<script>
    ...
    function UpFileImage(elem, url) {
        ...
        ajaxUpFile(url, formData, function (respTest) {
            ...
            document.getElementsByName('category_img')[0].value = img_url;
        })
    }
    ...
    function Submit() {
        ...
        var category_img =  document.getElementsByName('category_img')[0].value;
        ...
        ajaxUpFile('?c=ProductCategory&m=ajax_updateProductCategory', formdata, function (respText) {
