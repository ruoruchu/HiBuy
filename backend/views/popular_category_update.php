...
$popularCategoryInfo = $GLOBALS['popularCategoryInfo'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <input name="popular_category_id" type="text" value="<?php echo $popularCategoryInfo['popular_category_id']; ?>" hidden>
                                    <input id="x" name="popular_category_name" type="text" class="input-small"  value="<?php echo $popularCategoryInfo['popular_category_name']; ?>"/>
                                </div>
                            </div>
                                            ...
                                            <div class="widget-main">
                                                <div class="row">
                                                    <ul class="ace-thumbnails" id="list_image_src" style="list-style: none">
                                                        <li style="list-style: none;border: none"><a id="pre_img_a" href="" title="Photo Title" data-rel="colorbox"><img id="pre_img_img" src="<?php echo $popularCategoryInfo['popular_category_img']; ?>" ></a><div class="tools">
                                                                <a href="javascript:void(0);" onclick="DeleteImage(this);">
                                                                    <i class="icon-remove red"></i>
                                                                </a>
                                                            </div><input type="text" name="popular_category_img" hidden></li>
...
<script>
    ...
    function Submit() {
        ...
        ajaxUpFile('?c=PopularCategory&m=ajax_updatePopularCategory', formdata, function (respText) {
