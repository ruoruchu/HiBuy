							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input id="x" type="text" class="input-small" />
										</div>
									</div>
										...
										<div class="col-sm-4">
											...
											<div class="widget-box">
												<div class="widget-body">
													<input type="file" id="id-input-file-1" onchange="UpFileImage(this,list_image_src)"/>
													<div class="widget-main">
														<div class="row">
															<ul class="ace-thumbnails" id="list_image_src" >
																<li><a href="../frontend/image/w1.png" title="Photo Title" data-rel="colorbox"><img src="../frontend/image/w1.png"></a><div class="tools">
																		<a href="javascript:void(0);" onclick="DeleteImage(this);">
																			<i class="icon-remove red"></i>
																		</a>
																	</div><input type="text" value="" name="" hidden></li>
